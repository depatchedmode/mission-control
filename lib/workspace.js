...
import {
  SCHEMA_VERSION, OperationError, activeMentions, commentView, identifier, plain,
...
export class Workspace {
  ...
  snapshot() {
    ...
    return {
      ...
      comments: Object.fromEntries(Object.values(doc.comments).filter(comment => !comment.deleted.value).map(comment => [comment.id, commentView(comment)])),
