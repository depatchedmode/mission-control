...
// node_modules/@automerge/automerge-repo-react-hooks/dist/index.js
var import_react = __toESM(require_react());
var br = (0, import_react.createContext)(null);
function Ne() {
  const e = (0, import_react.useContext)(br);
  if (!e)
    throw new Error("Repo was not found on RepoContext.");
  return e;
}
function Tn(e) {
  const t = Ne(), r = e ? t.find(e) : null, n = (0, import_react.useRef)(r);
  r !== n.current && (n.current = r);
  const [, s] = (0, import_react.useState)(0), o = () => s((c) => c + 1);
  (0, import_react.useEffect)(() => !e || !r ? void 0 : (n.current = r, r.doc().then(() => {
    o();
  }).catch((a) => console.error(a)), r.on("change", o), r.on("delete", o), () => {
    r.removeListener("change", o), r.removeListener("delete", o);
  }), [e, r]);
  const i = (0, import_react.useCallback)(
    (c, a) => {
      r && r.change(c, a);
    },
    [r]
...
var ye = Symbol.for("_am_meta");
var Ee = Symbol.for("_am_trace");
var _e = Symbol.for("_am_objectId");
var pt = Symbol.for("_am_isProxy");
var Ht = Symbol.for("_am_clearCache");
var gr = Symbol.for("_am_uint");
var xr = Symbol.for("_am_int");
var wr = Symbol.for("_am_f64");
var $t = Symbol.for("_am_counter");
var mr = Symbol.for("_am_text");
var pe = class _pe {
  constructor(t) {
    if (typeof t == "string")
      this.elems = [...t];
    ...
    Reflect.defineProperty(this, mr, { value: true });
  }
  get length() {
  ...
  [Symbol.iterator]() {
    ...
    return {
      next() {
        return r += 1, r < t.length ? { done: false, value: t[r] } : { done: true };
      }
    };
  }
  /**
  ...
  concat(t) {
    return new _pe(this.elems.concat(t.elems));
  }
  every(t) {
    return this.elems.every(t);
  }
  filter(t) {
    return new _pe(this.elems.filter(t));
  }
  find(t) {
  ...
  slice(t, r) {
    return new _pe(this.elems.slice(t, r));
  }
  some(t) {
...
var vr = class {
  constructor(t) {
    this.value = t || 0, Reflect.defineProperty(this, $t, { value: true });
  }
  /**
...
function He(e, t) {
  var r, n;
  return e instanceof Date ? false : !!(e && ((n = (r = e[ye]) === null || r === void 0 ? void 0 : r.handle) === null || n === void 0 ? void 0 : n.__wbg_ptr) === t.__wbg_ptr);
}
var Er = {
  get(e, t) {
    const { context: r, objectId: n, cache: s } = e;
    return t === Symbol.toStringTag ? e[Symbol.toStringTag] : t === _e ? n : t === pt ? true : t === Ee ? e.trace : t === ye ? { handle: r, textV2: e.textV2 } : (s[t] || (s[t] = re(e, t)), s[t]);
  },
  set(e, t, r) {
...
var zt = {
  get(e, t) {
    const { context: r, objectId: n } = e;
    return t = ae(t), t === Symbol.hasInstance ? (s) => Array.isArray(s) : t === Symbol.toStringTag ? e[Symbol.toStringTag] : t === _e ? n : t === pt ? true : t === Ee ? e.trace : t === ye ? { handle: r } : t === "length" ? r.length(n) : typeof t == "number" ? re(e, t) : bt(e)[t];
  },
  set(e, t, r) {
    const { context: n, objectId: s, path: o, textV2: i } = e;
    if (t = ae(t), He(r, n))
  ...
  getOwnPropertyDescriptor(e, t) {
    const { context: r, objectId: n } = e;
    return t === "length" ? { writable: true, value: r.length(n) } : t === _e ? { configurable: false, enumerable: false, value: n } : (t = ae(t), { configurable: true, enumerable: true, value: re(e, t) });
  },
  getPrototypeOf(e) {
...
var _r = Object.assign({}, zt, {
  get(e, t) {
    const { context: r, objectId: n } = e;
    return t = ae(t), t === Symbol.hasInstance ? (s) => Array.isArray(s) : t === Symbol.toStringTag ? e[Symbol.toStringTag] : t === _e ? n : t === pt ? true : t === Ee ? e.trace : t === ye ? { handle: r } : t === "length" ? r.length(n) : typeof t == "number" ? re(e, t) : Or(e)[t] || bt(e)[t];
  },
  getPrototypeOf() {
  ...
  return {
    ...
    entries() {
      ...
      return {
        next: () => {
          const a = re(e, i);
          return a === void 0 ? { value: void 0, done: true } : { value: [i++, a], done: false };
        },
        [Symbol.iterator]() {
          return this;
        }
    ...
    keys() {
      ...
      const c = t.length(r);
      return {
        next: () => i < c ? { value: i++, done: false } : { value: void 0, done: true },
        [Symbol.iterator]() {
          return this;
        }
      };
    ...
    values() {
      ...
      return {
        next: () => {
          const a = re(e, i++);
          return a === void 0 ? { value: void 0, done: true } : { value: a, done: false };
        },
        [Symbol.iterator]() {
          return this;
        }
...
var Ir = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;
function Kt(e) {
...
var Wt;
var Jt = new Array(128).fill(void 0);
Jt.push(void 0, null, true, false);
Jt.length;
var Ge = typeof TextEncoder < "u" ? new TextEncoder("utf-8") : { encode: () => {
  throw Error("TextEncoder not available");
} };
Ge.encodeInto;
var jr = typeof TextDecoder < "u" ? new TextDecoder("utf-8", { ignoreBOM: true, fatal: true }) : { decode: () => {
...
var Br = Mr;
(function(e, t) {
  t.formatArgs = n, t.save = s, t.load = o, t.useColors = r, t.storage = i(), t.destroy = (() => {
    let a = false;
    return () => {
...
(function(e) {
  ...
  function s(a, p, d) {
    this.fn = a, this.context = p, this.once = d || false;
  }
  ...
  c.prototype.eventNames = function() {
    ...
    if (A.fn) {
      switch (A.once && this.removeListener(p, A.fn, void 0, true), I) {
        case 1:
          return A.fn.call(A.context), true;
        case 2:
          return A.fn.call(A.context, d), true;
        case 3:
          return A.fn.call(A.context, d, h), true;
        case 4:
          return A.fn.call(A.context, d, h, g), true;
        case 5:
          return A.fn.call(A.context, d, h, g, u), true;
        case 6:
          return A.fn.call(A.context, d, h, g, u, b), true;
      }
      ...
      var B = A.length, R;
      for (S = 0; S < B; S++)
        switch (A[S].once && this.removeListener(p, A[S].fn, void 0, true), I) {
          case 1:
    ...
    return o(this, p, d, h, false);
  }, c.prototype.once = function(p, d, h) {
    return o(this, p, d, h, true);
...
q.output = Qt;
var Vr = { number: Le, bool: Xt, bytes: xt, hash: Zt, exists: Yt, output: Qt };
q.default = Vr;
var wt = {};
var We = {};
...
(function(e) {
  ...
  e.byteSwap32 = d;
  const h = Array.from({ length: 256 }, (E, l) => l.toString(16).padStart(2, "0"));
  function g(E) {
    (0, r.bytes)(E);
    let l = "";
...
var Hr = (e, t, r) => e & t ^ ~e & r;
he.Chi = Hr;
var $r = (e, t, r) => e & t ^ e & r ^ t & r;
he.Maj = $r;
var zr = class extends Ae.Hash {
  constructor(t, r, n, s) {
    super(), this.blockLen = t, this.outputLen = r, this.padOffset = n, this.isLE = s, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(t), this.view = (0, Ae.createView)(this.buffer);
  }
  update(t) {
    (0, qe.exists)(this);
  ...
  digestInto(t) {
    (0, qe.exists)(this), (0, qe.output)(t, this), this.finished = true;
...
var le = new Uint32Array(64);
var er = class extends Ze.HashMD {
  constructor() {
    super(64, 32, 8, false), this.A = ce[0] | 0, this.B = ce[1] | 0, this.C = ce[2] | 0, this.D = ce[3] | 0, this.E = ce[4] | 0, this.F = ce[5] | 0, this.G = ce[6] | 0, this.H = ce[7] | 0;
  }
  get() {
...
var Gr = Jr;
var Xr = Gr;
var qr = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
var Zr = Xr(qr);
var Ye = Zr;
var Yr = function(e) {
  function t(o) {
...
var Fe = class _Fe {
  constructor(t) {
    if (t && ((t.keyMap || t._keyMap) && !t.useRecords && (t.useRecords = false, t.mapsAsObjects = true), t.useRecords === false && t.mapsAsObjects === void 0 && (t.mapsAsObjects = true), t.getStructures && (t.getShared = t.getStructures), t.getShared && !t.structures && ((t.structures = []).uninitialized = true), t.keyMap)) {
      ...
      for (let [r, n] of Object.entries(t.keyMap))
        this.mapKey.set(n, r);
    }
  ...
  */
  ...
  decode(t, r) {
    if (O)
      return ar(() => (lt(), this ? this.decode(t, r) : _Fe.prototype.decode.call(Ft, t, r)));
...
function ke() {
  try {
    ...
    throw lt(), (e instanceof RangeError || e.message.startsWith("Unexpected end of buffer")) && (e.incomplete = true), e;
  }
}
function P() {
  let e = O[w++], t = e >> 5;
    ...
    switch (e) {
      ...
      case 27:
        ...
        if (t > 1) {
          ...
          D.int64AsNumber ? (e = Y.getUint32(w) * 4294967296, e += Y.getUint32(w + 4)) : e = Y.getBigUint64(w);
        w += 8;
        break;
      case 31:
        switch (t) {
          ...
          case 5:
            ...
            if (D.mapsAsObjects) {
              ...
              if (D.keyMap)
                for (; (o = P()) != we; )
                  i[se(D.decodeKey(o))] = P();
              else
                for (; (o = P()) != we; )
                  i[se(o)] = P();
              return i;
            } else {
              Ce && (D.mapsAsObjects = true, Ce = false);
              let i = /* @__PURE__ */ new Map();
              if (D.keyMap)
                for (; (o = P()) != we; )
                  i.set(D.decodeKey(o), P());
              else
                for (; (o = P()) != we; )
                  i.set(o, P());
              return i;
...
var or = new Float32Array(1);
var Re = new Uint8Array(or.buffer, 0, 4);
function hn() {
...
var fr = (e) => {
  if (O[w++] != 132) {
    ...
    throw O.length < w && (r.incomplete = true), r;
  }
  let t = e();
  if (!t || !t.length) {
    let r = new Error("Packed values structure must be followed by a 4 element array");
...
W[28].handlesRead = true;
W[29] = (e) => {
  let t = ne.get(e);
  return t.used = true, t.target;
};
W[258] = (e) => new Set(e);
(W[259] = (e) => (D.mapsAsObjects && (D.mapsAsObjects = false, Ce = true), e())).handlesRead = true;
function me(e, t) {
...
var pn = new Uint8Array(new Uint16Array([1]).buffer)[0] == 1;
var kt = [
  Uint8Array,
  Uint8ClampedArray,
  Uint16Array,
...
var bn = [64, 68, 69, 70, 71, 72, 77, 78, 79, 85, 86];
...
function mt() {
  if (D.getShared) {
    ...
    D.sharedVersion = e.version, Q = D.sharedValues = e.packedValues, K === true ? D.structures = K = t : K.splice.apply(K, [0, t.length].concat(t));
  }
}
function ar(e) {
...
var vt = new Array(147);
for (let e = 0; e < 256; e++)
  vt[e] = +("1e" + Math.floor(45.15 - e * 0.30103));
var St = new Fe({ useRecords: false });
St.decode;
St.decodeMultiple;
var Me;
try {
...
var ut;
var cr;
var Je = typeof globalThis == "object" && globalThis.Buffer;
var je = typeof Je < "u";
var Qe = je ? Je.allocUnsafeSlow : Uint8Array;
var Rt = je ? Je : Uint8Array;
var Mt = 256;
var Bt = je ? 4294967296 : 2144337920;
var et;
var y;
var z;
var f = 0;
...
var wn = 61440;
var mn = /[\u0080-\uFFFF]/;
var ee = Symbol("record-id");
var vn = class extends Fe {
  constructor(t) {
    ...
    } : false, a = this, p = t.structures || t.saveStructures, d = t.maxSharedStructures;
    ...
    this.mapEncode = function(l, _) {
      ...
      if (s && (s = false), o = n || [], u = x, t.pack) {
        let m = /* @__PURE__ */ new Map();
        if (m.values = [], m.encoder = a, m.maxValues = t.maxPrivatePackedValues || (x ? 16 : 1 / 0), m.objectMap = x || false, m.samplingPackedValues = g, Be(l, m), m.values.length > 0) {
          y[f++] = 216, y[f++] = 51, fe(4);
          let C = m.values;
      ...
      try {
        ...
        if (s && a.saveShared) {
          ...
          return a.updateSharedData() === false ? a.encode(l) : m;
        }
        _ & En && (f = r);
      }
      ...
      for (let [C, v] of g)
        v.count > _ && (x[C] = m++, b.push(C), s = true);
    ...
    const S = (l) => {
      ...
      if (_ === "string") {
        ...
        if (!l)
          ...
          if (C === Object)
            ...
            if ((this.mapsAsObjects ? this.useTag259ForMaps !== false : this.useTag259ForMaps) && (y[f++] = 217, y[f++] = 1, y[f++] = 3), m = l.size, m < 24 ? y[f++] = 160 | m : m < 256 ? (y[f++] = 184, y[f++] = m) : m < 65536 ? (y[f++] = 185, y[f++] = m >> 8, y[f++] = m & 255) : (y[f++] = 186, z.setUint32(f, m), f += 4), a.keyMap)
              for (let [v, j] of l)
                S(a.encodeKey(v)), S(j);
            else
              for (let [v, j] of l)
            ...
            if (l[Symbol.iterator]) {
              if (et) {
                ...
                throw v.iteratorNotHandled = true, v;
              }
              y[f++] = 159;
              for (let v of l)
                S(v);
    ...
    }, B = this.useRecords === false ? this.variableMapSize ? (l) => {
      ...
      if (a.keyMap)
        for (let C in l)
          (typeof l.hasOwnProperty != "function" || l.hasOwnProperty(C)) && (S(a.encodeKey(C)), S(l[C]), m++);
      else
        for (let C in l)
          (typeof l.hasOwnProperty != "function" || l.hasOwnProperty(C)) && (S(C), S(l[C]), m++);
      ...
      if (this.keyMap) {
        ...
        for (let V in l)
          (typeof l.hasOwnProperty != "function" || l.hasOwnProperty(V)) && (m = C[V], m || (C[ee] & 1048576 && (k = C[ee] & 65535), m = C[V] = /* @__PURE__ */ Object.create(null), v++), C = m, j++);
      let T = C[ee];
      if (T !== void 0)
        ...
        C[ee] = T | 1048576, s = true;
      } else {
        if (C[ee] = T, z.setUint32(f, 3655335680), f += 3, v && (I += U * v), A.length >= Mt - d && (A.shift()[ee] = void 0), A.push(C), fe(j + 2), S(57344 + T), S(M), _)
          return;
        for (let V in l)
    ...
    function* L(l, _, m) {
      let C = l.constructor;
      if (C === Object) {
        let v = a.useRecords !== false;
        v ? B(l, true) : Tt(Object.keys(l).length, 160);
        for (let j in l) {
          let k = l[j];
        ...
        tt(l) ? (Tt(l.size, 64), yield y.subarray(r, f), yield l, H()) : l[Symbol.asyncIterator] ? (y[f++] = 159, yield y.subarray(r, f), yield l, H(), y[f++] = 255) : S(l);
    ...
    function ie(l, _, m) {
      return _ && _.chunkThreshold ? F = N = _.chunkThreshold : F = 100, l && typeof l == "object" ? (a.encode(null, rt), m(l, a.iterateProperties || (a.iterateProperties = {}), true)) : [a.encode(l)];
    }
    async function* E(l, _) {
      for (let m of L(l, _, true)) {
        let C = m.constructor;
  ...
  updateSharedData() {
    ...
    return s === false ? (n = this.getShared() || {}, this.structures = n.structures || [], this.sharedValues = n.packedValues, this.sharedVersion = n.version, this.structures.nextId = this.structures.length) : r.forEach((o, i) => this.structures[i] = o), s;
  }
};
function Tt(e, t) {
...
var An = new Uint8Array(new Uint16Array([1]).buffer)[0] == 1;
cr = [
  Date,
  Set,
  Error,
...
ut = [
  ...
  },
  {
    // Uint8Array
    getTag(e) {
      if (e.constructor === Uint8Array && (this.tagUint8Array || je && this.tagUint8Array !== false))
        return 64;
    },
    encode(e, t, r) {
      Dt(e, r);
...
var At = new vn({ useRecords: false });
At.encode;
At.encodeAsIterable;
        ...
        return g.prototype.reset = function() {
          ...
          if (!this.finished) {
            ...
            for (var S = x + 1; S < U - 8; S++)
              this.buffer[S] = 0;
            this.buffer[U - 8] = A >>> 24 & 255, this.buffer[U - 7] = A >>> 16 & 255, this.buffer[U - 6] = A >>> 8 & 255, this.buffer[U - 5] = A >>> 0 & 255, this.buffer[U - 4] = I >>> 24 & 255, this.buffer[U - 3] = I >>> 16 & 255, this.buffer[U - 2] = I >>> 8 & 255, this.buffer[U - 1] = I >>> 0 & 255, n(this.temp, this.state, this.buffer, 0, U), this.finished = true;
          }
          for (var S = 0; S < 8; S++)
...
var Dn = (e) => {
  const [t, r] = (0, import_react.useState)({}), n = Ne(), s = (0, import_react.useMemo)(
    () => e?.map((i) => {
      if (nn(i)) {
...
var In = () => {
  const [e, t] = (0, import_react.useState)(window.location.hash);
  return (0, import_react.useEffect)(() => {
...
var ur = (e, t) => new URLSearchParams(t.slice(1)).get(e);
var Un = (e, t, r) => {
  const n = new URLSearchParams(r.slice(1));
  return n.set(e, t), n.toString();
};
var Fn = (e, t) => e && (ur(e, t) || localStorage.getItem(e));
var jn = (e, t) => {
...
var Ln = ({
  ...
  const n = Ne(), s = In(), o = (0, import_react.useMemo)(() => {
    const i = Fn(e, s);
    try {
...
@automerge/automerge-repo-react-hooks/dist/index.js:
